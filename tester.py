...
controller.draw.draw(godzilla, 5, 4, 's')
...
# grid.create()
#
# sprite_x = Sprite.Sprite("/Users/orlandotorres/PycharmProjects/Grids/images/x.png", 50, 50, 'center')
# sprite_x.create()
# sprite_zero = Sprite.Sprite("/Users/orlandotorres/PycharmProjects/Grids/images/zero.png", 50, 50, 'center')
# sprite_zero.create()
#
# controller = Controller.Controller(window, grid)
# controller.draw.drawGrid()
